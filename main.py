...
batch_size = 30
resnet_v1=RESNET_V1('adam' , True , True , logit_type='gap' , datatype= 'my_data' ,batch_size=batch_size ,\
                    cropped_size=315, num_epoch=10,init_lr = 0.0001, lr_decay_step= 100 ,model = model_name , aug_list=['aug_lv0','aug_lv1','aug_rotate'])
