...
predStrength=list(predStrength[indices[50:150]]) + list(predStrength[rev_indices[40:60]])
test_cls=list(test_cls[indices[50:150]]) + list(test_cls[rev_indices[40:60]])
